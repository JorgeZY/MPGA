...
def main():
    ...
    while True:        
        ...
        while (count < 10):
            ...
            draw.text((x, top+45), "RTemp. : ", fill="white")
        ...
        while (count < 1):
            ...
            draw.text((x, top+55), str(temp_min) + "C -" + str(temp_max) + "C",  font=font, fill=255)
